...
The *SlideEASY* plugin allows you to create slides that consist of linked (to any url) images and titles. The slider would then take those slides and present them as a jQuery-powered slideshow - at a chosen location within your theme, page, or post. In whatever order you want them.


The main purpose of the *SlideEASY* is to serve as an effective addition to **responsive WordPress themes**, as it would automatically adjust to its container. This would work out of the box - there is no need for additional CSS or JavaScript tweaks from your theme.

== Installation ==

1. Upload the plugin folder `slidereasy` to the `/wp-content/plugins/` directory.
1. Activate the plugin through the "Plugins" menu in WordPress. A new item **"SlideEASY"** would appear in the admin menu. 
1. Go to **SlideEASY -> Settings** and configure the slider options.
1. Go to **SlideEASY -> Add New Slide** and create a few slides.
